...
RUN comfy model download --url https://transfer.apavlov.net/-tryraGpUGT/qwen_2512_GP_4x6_deluxe_2500s.safetensors --relative-path models/loras --filename qwen_image_vae.safetensors
